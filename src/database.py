...
def initialize_database(database_path: Path) -> None:
    """
    Create every table required by the application.
...
def save_invoice(
    ...
    """
    Save an invoice and all of its line items.
...
def get_invoice_line_items(
    ...
    """
    Return every purchased item
    belonging to one invoice.
    """
...
def delete_invoice(
    ...
    Its line items are automatically deleted
...
def get_all_invoices(
    ...
    Each invoice also includes its purchased
    line items.
    """
    ...
    for row in rows:
        ...
        invoice["line_items"] = get_invoice_line_items(
            database_path,
            invoice["id"],
        )
